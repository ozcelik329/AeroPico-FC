...
export default function Hero() {
  ...
  return (
    <main id="top" className="site-container py-14 md:py-20 relative z-10">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <section className="space-y-6 relative z-10" aria-labelledby="hero-title">
          ...
          <h1 id="hero-title" className="text-4xl md:text-6xl font-extrabold tracking-tight leading-tight">
            Küçük Kart <br />
