...
class ParamManager {
  ...
  private:
    Param _params[PARAM_COUNT] = {
        ...
        {"EN_BARO", AEROPICO_DEFAULT_EN_BARO ? 1.0f : 0.0f, 0.0f, 1.0f},
        {"EN_MAG", AEROPICO_DEFAULT_EN_MAG ? 1.0f : 0.0f, 0.0f, 1.0f},
        {"EN_GPS", AEROPICO_DEFAULT_EN_GPS ? 1.0f : 0.0f, 0.0f, 1.0f},
        {"EN_BATT", AEROPICO_DEFAULT_EN_BATT ? 1.0f : 0.0f, 0.0f, 1.0f},
        {"EN_RC", AEROPICO_DEFAULT_EN_RC ? 1.0f : 0.0f, 0.0f, 1.0f},
